...
setwd("C:/Users/vishu/Documents/Data/Text Mining/r")
...
inspect(sms_corpus[2])

class(corpus_clean)


# create a document-term sparse matrix
#clean corpus are converted into DTM
...
#making a clean corpus of only spam i.e spam type and text against it
#earlier we made a clean corpus of whole data
...
inspect(spam_clean)
class(spam_clean)
#making a DTM of spam clean corpus
